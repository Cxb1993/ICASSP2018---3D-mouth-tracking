...
% Define the four corners of the 3D face rectangle in the camera coordinates
switch bodypart
    case 2 % Upperbody
        % Suggested: Fw = 0.4, Fh=0.4
        F = [Fw/2,  Fh/2,0, 1;
            -Fw/2,  Fh/2,0, 1;
            -Fw/2,   -Fh/2,0, 1;
            Fw/2,   -Fh/2,0, 1];
    case 1 % body/torso
        % Suggested: Fw = 0.35, Fh=0.5
        F = [Fw/2,  -0.1,0.12, 1;
            -Fw/2,  -0.1,0.12, 1;
            -Fw/2,   -0.1-Fh,0.12, 1;
            Fw/2,   -0.1-Fh,0.12, 1];
    case 0 % face
        % Suggested: Fw = 0.15, Fh=0.2
...
for n=1:N
    ...
    p2d = myproject( S(1,:)', C); % top-left corner point
    bbimg(1:2) = p2d(1:2);
    p2d = myproject( S(3,:)', C); % bottom right corner point
    bbimg(3:4) = p2d(1:2);
